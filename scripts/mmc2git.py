...
mmc_path = user_path + "/Documents/MultiMC/instances/Above and Beyond Forge/"
...
with open(git_path + "/MultiMC/Above and Beyond Forge x.y.z/instance.cfg", "r+") as file:
data = pattern.sub(version, file.read())
file.seek(0); file.truncate(); file.write(data)

copy_to_archive(git_path + "/MultiMC/Above and Beyond Forge x.y.z/instance.cfg", f"Above and Beyond Forge {version}/instance.cfg", output_path + f"Above and Beyond Forge {version}.zip")
copy_file(mmc_path + "mmc-pack.json", git_path + "MultiMC/Above and Beyond Forge x.y.z/mmc-pack.json", "MultiMC mmc-pack.json", "Git")
copy_file(mmc_path + "pack.png", git_path + "MultiMC/Above and Beyond Forge x.y.z/pack.png", "MultiMC pack.png", "Git")
